...
- **[LM Studio](https://lmstudio.ai)** — download, load a model, start the local server, and enable CORS under *Settings → Local Server → Enable CORS*
- **[Ollama](https://ollama.com)** — install, pull a model (`ollama pull <model>`), and set `OLLAMA_ORIGINS=*` before starting (`ollama serve`)

### Option 1 — Firefox (online, no download needed)

Open the app directly in your browser:

👉 **https://sprengholz.github.io/annotaid**
...
https://github.com/sprengholz/annotaid/blob/main/DEVELOPER.md
